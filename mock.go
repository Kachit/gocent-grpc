...
//			},
//			RateLimitFunc: func(ctx context.Context, in *RateLimitRequest, opts ...grpc.CallOption) (*RateLimitResponse, error) {
//				panic("mock out the RateLimit method")
//			},
...
type CentrifugoApiClientMock struct {
	...
	// RateLimitFunc mocks the RateLimit method.
	RateLimitFunc func(ctx context.Context, in *RateLimitRequest, opts ...grpc.CallOption) (*RateLimitResponse, error)
	...
	calls struct {
		...
		// RateLimit holds details about calls to the RateLimit method.
		RateLimit []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// In is the in argument value.
...
// RateLimit calls RateLimitFunc.
func (mock *CentrifugoApiClientMock) RateLimit(ctx context.Context, in *RateLimitRequest, opts ...grpc.CallOption) (*RateLimitResponse, error) {
	if mock.RateLimitFunc == nil {
		panic("CentrifugoApiClientMock.RateLimitFunc: method is nil but CentrifugoApiClient.RateLimit was just called")
	}
	callInfo := struct {
		Ctx  context.Context
		In   *RateLimitRequest
	...
	mock.lockRateLimit.Lock()
	mock.calls.RateLimit = append(mock.calls.RateLimit, callInfo)
	mock.lockRateLimit.Unlock()
	return mock.RateLimitFunc(ctx, in, opts...)
}

// RateLimitCalls gets all the calls that were made to RateLimit.
// Check the length with:
//
//	len(mockedCentrifugoApiClient.RateLimitCalls())
func (mock *CentrifugoApiClientMock) RateLimitCalls() []struct {
	Ctx  context.Context
	In   *RateLimitRequest
	Opts []grpc.CallOption
} {
	...
	mock.lockRateLimit.RLock()
	calls = mock.calls.RateLimit
	mock.lockRateLimit.RUnlock()
	return calls
}
